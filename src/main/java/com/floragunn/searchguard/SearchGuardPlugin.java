...
//Filewatcher: watch changed files (ssl, keys, etc)
//http should return appripriate reposne codes, 401 <> 500
public final class SearchGuardPlugin extends Plugin {
    ...
    public void onModule(final TransportModule module) {
        ...
        if (!client) {
            ...
            // module.setTransportService(SearchGuardTransportService.class,
            // name());
