...
sudo cp -vv /vagrant/search-guard-ssl/example-pki-scripts/truststore.jks $ES_PLUGIN_DIR/search-guard-2/sgconfig/truststore.jks
sudo cp -vv /vagrant/search-guard-ssl/example-pki-scripts/kirk-keystore.jks $ES_PLUGIN_DIR/search-guard-2/sgconfig/kirk-keystore.jks
sudo cp -vv /vagrant/search-guard-ssl/example-pki-scripts/kirk*.pem $ES_PLUGIN_DIR/search-guard-2/sgconfig/
sudo cp -vv /vagrant/search-guard-ssl/example-pki-scripts/kirk*.p12 $ES_PLUGIN_DIR/search-guard-2/sgconfig/
sudo cp -vv /vagrant/search-guard-ssl/example-pki-scripts/ca/root-ca.pem $ES_PLUGIN_DIR/search-guard-2/sgconfig/
sudo cat /vagrant/search-guard-ssl/example-pki-scripts/kirk.crt.pem /vagrant/search-guard-ssl/example-pki-scripts/ca/chain-ca.pem > /vagrant/ch.pem
...
#Admin
sudo chmod +x $ES_PLUGIN_DIR/search-guard-2/tools/sgadmin.sh
...
curl -Ss -XGET  \
 ...
 curl -Ss -XGET  \
  --insecure \
 -u spock:spock https://10.0.3.112:9200/_searchguard/authinfo?pretty
 
  curl -Ss -XGET  \
  --insecure \
 -u spock:spock https://10.0.3.113:9200/_searchguard/authinfo?pretty
...
sudo $ES_PLUGIN_DIR/search-guard-2/tools/sgadmin.sh -h $CONNECT_IP -cd /vagrant/demo/conf2 -ks $ES_PLUGIN_DIR/search-guard-2/sgconfig/kirk-keystore.jks -ts $ES_PLUGIN_DIR/search-guard-2/sgconfig/truststore.jks  -nhnv
echo "sgadmin.sh done, test it again"  
...
curl -Ss -XGET  \
 ...
 sudo $ES_PLUGIN_DIR/search-guard-2/tools/sgadmin.sh -h $CONNECT_IP -cd /vagrant/demo/conf -ks $ES_PLUGIN_DIR/search-guard-2/sgconfig/kirk-keystore.jks -ts $ES_PLUGIN_DIR/search-guard-2/sgconfig/truststore.jks  -nhnv
echo "sgadmin.sh done, test it again againagain"  
